...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert(title="Suma", message="El resultado de la suma es:" + resultado_texto)
    ...
    def btn_restar_on_click(self):
        ...
        resultado= operador_a_numero - operador_b_numero
        resultado_texto= str(resultado)
        alert(title="Resta", message="El resultado de la resta es:" + resultado_texto)
    ...
    def btn_multiplicar_on_click(self):
        ...
        resultado= operador_a_numero * operador_b_numero
        resultado_texto= str(resultado)
        alert(title="Multiplicacion", message="El resultado de la multiplicacion es:" + resultado_texto)
    ...
    def btn_dividir_on_click(self):
        ...
        resultado= operador_a_numero / operador_b_numero
        resultado_texto= str(resultado)
        alert(title="Division", message="El resultado de la division es:" + resultado_texto)
